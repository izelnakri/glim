...
window.GlimmerApplication = Application;
...
export default function(containerElement, moduleMap, ENV) {
  ...
  const app = new window.GlimmerApplication({
  ...
  app.registerInitializer({
    initialize(registry) {
      registry.register(`component-manager:/${app.rootName}/component-managers/main`, window.ComponentManager);
    }
  });
